...
class TweetController{
    ...
    async getAllTweets(){
        ...
        return await this.service.getAllTweets().filter((element) => element % 2 == 0); // QUe este arreglo, que es la fuente de datos, se regrese desde la base de datos. No conectar ninguna base de datos. Primer comit
    }
}
